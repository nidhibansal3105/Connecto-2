      ...
      {matches.map((s, i) => (
        <div key={s.id} className="fm-suggestion-item">
          ...
          <div className="fm-sug-info">
            ...
            <div className="fm-sug-detail">
              {s.shared?.length || 0} shared communities
            </div>
          </div>
...
const STEPS = [
  ...
  },
  {
    ...
    desc: "Active members get prioritized in results",
  },
  {
    title: "Campus Proximity",
    desc: "Same year & department boosts your score",
  },
  {
    title: "Connect & Chat",
    desc: "Send a connection request to start your journey",
  },
];
